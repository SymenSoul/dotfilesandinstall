...
async function getActions(store, doc, pos) {
    ...
    return provider.getActions(doc, lsp.Range.create(pos, pos), lsp.CodeActionContext.create([], undefined, undefined), cancellation_1.noopToken);
}
...
suite('Extract link definition code action', () => {
    ...
    test('Extract should extract entire autolink', (0, util_1.withStore)(async (store) => {
        const doc = new inMemoryDocument_1.InMemoryDocument((0, util_1.workspacePath)('test.md'), (0, util_1.joinLines)(`Lorem <https://daringfireball.net/projects/markdown> dolor`));
        const actions = await getActions(store, doc, { line: 0, character: 20 });
        assertActiveActionCount(actions, 1);
        const newContent = (0, util_1.applyActionEdit)(doc, actions[0]);
        assert.strictEqual(newContent, (0, util_1.joinLines)(`Lorem [def] dolor`, ``, `[def]: https://daringfireball.net/projects/markdown`));
    }));
});
