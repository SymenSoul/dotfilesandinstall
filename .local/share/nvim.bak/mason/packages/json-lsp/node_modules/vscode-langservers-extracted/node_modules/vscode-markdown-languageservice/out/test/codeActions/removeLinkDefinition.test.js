...
async function getActions(store, doc, pos) {
    ...
    return Array.from(provider.getActions(doc, lsp.Range.create(pos, pos), lsp.CodeActionContext.create((await computer.compute(doc, util_1.defaultDiagnosticsOptions, cancellation_1.noopToken)).diagnostics, undefined, undefined)));
}
