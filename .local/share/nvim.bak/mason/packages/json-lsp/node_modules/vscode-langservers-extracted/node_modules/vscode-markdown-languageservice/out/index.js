...
const hover_1 = require("./languageFeatures/hover");
...
const updatePastedLinks_1 = require("./languageFeatures/updatePastedLinks");
...
function createLanguageService(init) {
    ...
    const rewritePastedLinksProvider = new updatePastedLinks_1.MdUpdatePastedLinksProvider(config, linkProvider);
    const hoverProvider = new hover_1.MdHoverProvider(linkProvider);
