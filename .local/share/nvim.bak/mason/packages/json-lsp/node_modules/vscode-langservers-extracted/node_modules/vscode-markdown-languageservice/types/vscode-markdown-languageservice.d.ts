import { Event as Event_2 } from 'vscode-languageserver-protocol';
...
export declare interface IMdLanguageService {
    ...
    }, token: lsp.CancellationToken): Promise<lsp.DocumentSymbol[]>;
    /**
     ...
     */
    getCompletionItems(document: ITextDocument, position: lsp.Position, context: MdPathCompletionOptions, token: lsp.CancellationToken): Promise<lsp.CompletionItem[]>;
    /**
    ...
    }, token: lsp.CancellationToken): Promise<lsp.TextEdit[]>;
    /**
     ...
     */
    prepareRename(document: ITextDocument, position: lsp.Position, token: lsp.CancellationToken): Promise<{
        range: lsp.Range;
        placeholder: string;
    } | undefined>;
    /**
     ...
     */
    getRenameFilesInWorkspaceEdit(edits: readonly FileRename[], token: lsp.CancellationToken): Promise<{
     ...
     * @param paste Edits that apply the paste. These must not overlap.
...
export declare interface IWorkspace {
     ...
     */
    readonly onDidChangeMarkdownDocument: Event_2<ITextDocument>;
    /**
     * Fired when a markdown document is first created.
     */
    readonly onDidCreateMarkdownDocument: Event_2<ITextDocument>;
    /**
     * Fired when a markdown document is deleted.
     */
    readonly onDidDeleteMarkdownDocument: Event_2<URI>;
    /**
